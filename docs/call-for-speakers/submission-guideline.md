...
All speakers are required to adhere to CNCF's [Code of Conduct](https://github.com/cncf/foundation/blob/main/code-of-conduct.md)

## Avoid AI slop

Avoid submitting low-effort, AI-generated proposals. While we don't ban the use of AI, especially since it can be a helpful tool for non-native English speakers, we strongly discourage submissions that appear to be low-quality or clearly [AI-generated slop](https://en.wikipedia.org/wiki/AI_slop)
...
Please select the format that best fits your content (refer to [Session Type](./session-type.md) page). Clear session types make it easier for our committee to evaluate your proposal. You should also select the correct content category as listed in [Session Category](./session-category.md)
